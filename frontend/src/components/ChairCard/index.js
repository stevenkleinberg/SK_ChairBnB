    ...
    return (
        <div className="chair-card" >
            <div className="chair-card__body">
                <img className="chair-card__img" src="https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" />
